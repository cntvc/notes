...
- Brevo：国内连通性良好，虽然注册过程比较曲折，但最终还是选择了这个平台
> Brevo 主要业务是用来定制群发的营销邮件，免费用户每天可以发送 300 封邮件，并且支持设置自定义域名邮箱
> 
> 这里简要描述下我注册时遇到的两个问题
> 
> 一是目前注册流程中需要验证手机号，但 +86 手机无法收到短信或者语音验证码，最后是通过工单来让客服手动完成这个步骤
> 
> 二是注册完后账号立刻被风控了，我猜测可能是由于注册时 IP 地址是 VPN 出口，被识别为重复注册的账户。通过工单联系解封，在按要求验证域名后，解释一番仍未通过，最后他们给出解决方案是**单独开放账号的 SMTP 功能**
